...
def is_line(positions: List):
        ...
        elif([4,2] in positions and [4,3] in positions and [5,5] in positions):
            return True, [[4,2],[4,3],[5,5]] 
        ...
        elif([2,4] in positions and [3,4] in positions and [5,5] in positions):
            return True, [[2,4],[3,4],[5,5]]
